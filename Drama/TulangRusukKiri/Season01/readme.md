...
75. Hero : ok sekarang taip
76. Hero : [tab]-[tab]-/* 4. semak sama ada dalam folder KAWAL $fail benar2 wujud-[enter]
77. Hero : [tab]-[tab]-[ruang]* jika ya : masukkan $fail dan isytihar class tersebut-[enter]
78. Hero : [tab]-[tab]-[ruang]* jika tak : cari fungsi sesat()-[enter]
79. Hero : [tab]-[tab]-[ruang]*/-[enter]
80. Amoi : [tab]-[tab]-/* 4. semak sama ada dalam folder KAWAL $fail benar2 wujud-[enter]
81. Amoi : [tab]-[tab]-[ruang]* jika ya : masukkan $fail dan isytihar class tersebut-[enter]
82. Amoi : [tab]-[tab]-[ruang]* jika tak : cari fungsi sesat()-[enter]
83. Amoi : [tab]-[tab]-[ruang]*/-[enter]
84. Hero : ok sekarang taip
85. Hero : [tab]-[tab]-if (file_exists($fail))-[enter]
86. Hero : [tab]-[tab]-{-[enter]
87. Hero : [tab]-[tab]-[tab]-$kawal = new $Url[0];-[enter]
88. Hero : [tab]-[tab]-[tab]-$kawal->jemaahTaskil($url[0]);-[enter]
89. Hero : [tab]-[tab]-[tab]-# jika $url[1] tak disetkan, bagi $method='index'-[enter]
90. Hero : [tab]-[tab]-[tab]-$method = (isset($url[1])) ? $url[1] : 'index';-[enter]
91. Hero : [tab]-[tab]-[tab]-# semak sama ada method ada dalam $kawal-[enter]
92. Hero : [tab]-[tab]-[tab]-if ( !method_exists($kawal, $method))-[enter]
93. Hero : [tab]-[tab]-[tab]-[tab]-$this->parameter();-[enter]
94. Hero : [tab]-[tab]-[tab]-else $this->cari_pengawal($kawal, $url);-[enter]
95. Hero : [tab]-[tab]-[tab]-//*/-[enter]
96. Hero : [tab]-[tab]-[tab]-}-[enter]
97. Hero : [tab]-[tab]-[tab]-else $this->sesat();-[enter]-[enter]-[tab]-}
